...
import './AgreementBetweenContractor.css';

const AgreementBetweenContractor = () => {
  return (
    <div className="">
      <h1 className="">Agreement Between Contractor And Principal Employer</h1>

      <p className="">
        <strong>SUGGESTED FORMAT OF AGREEMENT BETWEEN CONTRACTOR AND PRINCIPAL EMPLOYER</strong>
      </p>
      <p>
        This Agreement is made on this day at <em>(Specify the Place)</em> BETWEEN THE MANAGEMENT of <em>(Name of the management)</em>
        through its authorized signatory (hereinafter referred as party of first Part) AND M/s—————————————————————————————
        through its proprietor Shri ————————————- (hereinafter referred to as THE CONTRACTOR), party of the Second Part.
      </p>

      <p>
        WHEREAS the party on the first part requires the services of an expert contractor; AND WHEREAS the party of the Second Part has
        approached the party of the First Part and offered its services for the purpose on the assurance that it possesses the equipment,
        expertise, manpower skill, and facilities to provide high-quality services.
      </p>
      ...
      <p>
        <p>
          The first party by means of these presents allows the Contractor to perform and execute all services in respect of the areas
          specified in Annexure to this Agreement. The specified area may be increased or decreased from time to time at the discretion of
          the party of the first part, whereupon, the Contractor shall proportionately increase or decrease, as the case may be, the work
          force and equipment employed on the basis of the present standard. (It is important to give entire details of the scope of work in
          the Agreement Between Contractor And Principal Employer to avoid any future dispute)
        </p>
        <br></br>
        <p>
          The Contractor, by means of this Agreement, agrees to execute, fulfill and discharge the obpgations and perform the services,
          hereinafter provided in the manner hereinafter appearing. For the service rendered as per this Agreement, the party of the first
          part shall pay to the Contractor at the rates mutually agreed upon from time to time in writing. The total manpower at present for
          the performance of the described jobs to the Contractors. The payment agreed to be made for the performance of the tasks assigned
          to the Contractor is Rs. ————————————————————————per month. The amount includes all legal obligations besides services charges.
        </p>
        <p>
          The Contractor shall submit its bill in respect of housekeeping services provided during a month immediately after the close of
          the month. After verification of the correctness of the bill, the party of the First Part will make payment to the Contractor by
          means of an Account Payee cheque after deducting income-tax as provided for under the Income Tax Act 1961. (The bank account details
          may also be mentioned in the Agreement Between Contractor And Principal Employer)
        </p>
        <p>
      ...
      <p className="">
        <strong>IN WITNESS WHEREOF the parties hereto have set their hands to this Agreement in the presence of witnesses:</strong>
      </p>
      <p>PARTY OF THE FIRST PART (MANAGEMENT)</p>
      <p>PARTY OF THE SECOND PART (CONTRACTOR)</p>
      <p>WITNESS</p>
    </div>
  );
};
export default AgreementBetweenContractor;
