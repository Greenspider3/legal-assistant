...
const API_KEY = "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";
...
function ChatBot() {
  ...
  async function processMessageToChatBOT(chatMessages) { // messages is an array of messages
  ...
  return (
    <div className="App">
      <div style={{ position:"relative", height: "650px", width: "1450px"  }}>
        <MainContainer>
          <ChatContainer>       
            <MessageList 
